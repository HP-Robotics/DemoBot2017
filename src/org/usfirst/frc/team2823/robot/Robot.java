...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		leftControl = new SnazzyMotionPlanner(1, 0, 0, 0, 0.0000168033, 0.00011537, l, tLeft, 0.01, "Left.csv");
		rightControl = new SnazzyMotionPlanner(1, 0, 0, 0, 0.0000168033, 0.00011537, r, new InvertedPIDOutput(tRight), 0.01,"Right.csv");
	...
	public void testPeriodic(){
		...
		if(joystick.getRawButton(1) && !toggle){
			//leftControl.setSetpoint(50* IN_TO_ENC);
			leftControl.configureGoal(50*IN_TO_ENC, 9000, 30000, true);
			leftControl.enable();
			//leftControl.startCalibration();
			//leftControl.enableLog("LeftOld.csv");
			
			//rightControl.setSetpoint(50 * IN_TO_ENC);
			rightControl.configureGoal(50*IN_TO_ENC, 9000, 30000, true);
			rightControl.enable();
